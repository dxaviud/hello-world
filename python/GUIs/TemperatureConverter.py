...
class Converter(object):
    ...
    def display(self):
        ...
        fah_label.grid(row=2, column=0, padx=5, pady=5)
        ...
        def fah_to_cent():
            ...
            try:
                ...
                print("Fahrenheit temperature is invalid")
                return
        ...
        def cent_to_fah():
            ...
            try:
                ...
                print("Celsius temperature is invalid")
                return

                
            result = cent_float * 1.8 + 32
            fah_entry.delete(0) # remove the old text
            fah_entry.insert(0, str(result)) # insert the new text
